...
customFields.command("create").description("Create a custom field definition")
  ...
  .option("--scope <scopes>", "Comma-separated or repeated. Aliases: transactions, contacts, projects. Or pass a raw path like /transactions/Transaction. Default: transactions.", (val: string, prev: string[] = []) => prev.concat(val.split(",")))
