...
export function generateCompletions(words: string[]) {
  ...
  if (words[0] === "intuit") words = words.slice(1);
...
export function completionsBash(): string {
...
export function completionsZsh(): string {
